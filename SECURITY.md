# Security Policy — asc-screens

## Private Reporting

Report vulnerabilities through GitHub private vulnerability reporting or email `contact@magrathean.uk` with subject `SECURITY: asc-screens`.
